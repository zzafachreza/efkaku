...
export default function HalamanGlobal({ navigation }) {
    return (
        <SafeAreaView style={{
            flex: 1,
        }}>
            <View style={{
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('HalamanTier')} style={{
                ...
                <View style={{
                    ...
                    }}>Peringkat Global</Text>
                    <Text style={{
                        color: colors.white,
                        fontSize: 14,
                        fontFamily: fonts.secondary[400]
                    }}>Peringkat 100 Teratas</Text>
                </View>
            </View>
            <View style={{
                flex: 0.5,
